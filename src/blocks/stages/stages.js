import "./__content/stages__content";
...
(function($) {
  ...
  $.fn.stepbar = function(opts) {
    ...
    for(var i = 0; i < items.length; i++) {
      ...
      layer2.fillText(iLabel, thisX - (metrics.width / 2), thisY + (fontSize / 2) - 2);
      
      layer2.font = 'bold ' + fontSize + 'px Lato-Black';
